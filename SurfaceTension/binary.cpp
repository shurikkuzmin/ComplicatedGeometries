...
int main(int argc, char* argv[])
{
    ...
    if (argc==6)
    {
        ...
        viscosity_ratio=atof(argv[4]);
        tau_liq=viscosity_ratio*(tau_gas-0.5)+0.5;
        surface_ratio=atof(argv[5]);
        aconst=0.04*surface_ratio;
        kconst=0.04*surface_ratio;
     }
	std::cout<<"Radius of the droplet is "<<radius_droplet<<"\n";
	std::cout<<"Wall gradient is "<<wall_gradient<<"\n";
    std::cout<<"Viscosity ratio is "<<viscosity_ratio<<"\n";
    std::cout<<"Tau_gas and tau_liq="<<tau_gas<<" "<<tau_liq<<"\n";
    std::cout<<"Surface ratio"<<surface_ratio<<"\n";
    std::cout<<"Aconst="<<aconst<<" kconst="<<kconst<<"\n";
